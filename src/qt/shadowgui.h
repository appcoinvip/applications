...
#include <stdint.h>
#include <QDir>
#include <chat/view/dlg/logining.h>
#include <chat/view/module/widget.h>
#include <chat/view/dlg/userdefineddlg.h>
#include <chat/view/dlg/suspenddlg.h>
#include <chat/view/module/mediaplayer_1.h>
#include <QSound>
...
private:
    int stat;
    UserDefinedDlg *chatDlg;
    UserDefinedDlg *exchangeDlg;
    SuspendDlg *rewardDlg;
    MediaPlayer_1 play;
    QWebView *webView;
...
private slots:
    ...
    */
    ...
    void aeraClicked();
    void aera1Clicked();
    QString getAddressID();
    void createMusic(QString mpUrl);
};
